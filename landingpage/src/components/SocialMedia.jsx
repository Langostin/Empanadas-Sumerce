...
/* All social icons as inline SVGs — avoids lucide-react export issues */
...
export default function SocialMedia() {
  ...
  return (
    <section className="section social-section" id="redes" ref={ref}>
      <div className="container social-content">
        <h2 className="section-title">Síguenos en Redes</h2>
        <p className="section-subtitle">
          Mantente al día con nuestras novedades, promociones y detrás de cámaras
        </p>
